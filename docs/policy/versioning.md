...
|-----------|---------------|---------|
| Mouseion | `mouseion/*.csproj` (PropertyGroup > Version) | Pre-stable |
| Akroasis Web | `akroasis/web/package.json` | Pre-stable |
| Akroasis Android | `akroasis/android/app/build.gradle` (versionName) | Pre-stable |
