...
Feed fetching does not use the want/release/have pipeline. There is no search or grab step; the feed URL is the source. See the News exception section in `want-release.md`.
